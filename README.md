...
### Overview
This project demonstrates how to deploy a Production-ready 2-Tier Architecture on AWS using Terraform IaC (Infrastructure as Code). The architecture includes a Network Tier (VPC layer) and Application Tier (EC2 layer) with secure communication between them.
